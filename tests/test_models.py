...
from justpen_knowledgebase_mcp.models import DeleteRequest, GetRequest, NodeRef, NodeWrite, WriteRequest, WriteResult
...
def test_result_models_are_closed():
    ...
    result = WriteResult.model_validate(
        {
            "nodes": [{"id": str(uuid4()), "created": True, "updated": False, "links_added": 0, "links_removed": 0}],
            "relations": [],
        }
    )
