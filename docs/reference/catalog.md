...
| `authenticates`        | `secret`                                                                                                                                                                                                                                                         | `email_address`, `cloud_account`, `identity_tenant`, `repository`, `service`, `endpoint`, `storage_bucket`, `cloud_resource` | no        | `username`, `breach`                                                                  | `breach`: `breach_token_or_empty`<br>`username`: `username_or_empty`                                                        |
...
| `exposes_secret`       | `repository`, `endpoint`, `storage_bucket`, `cloud_resource`                                                                                                                                                                                                     | `secret`                                                                                                                     | no        | `location`                                                                            | `location`: `printable_text_1024`                                                                                           |
| `federates_with`       | `domain`, `subdomain`                                                                                                                                                                                                                                            | `identity_tenant`                                                                                                            | no        | —                                                                                     | —                                                                                                                           |
| `has_contact`          | `organization`, `registrar`, `domain`, `subdomain`, `repository`, `whois_registration`                                                                                                                                                                           | `email_address`, `phone`, `endpoint`                                                                                         | no        | `role`                                                                                | `role`: one of `abuse`, `admin`, `tech`, `registrant`, `billing`, `noc`, `security`, `published`, `iodef`                   |
| `has_dkim_selector`    | `domain`, `subdomain`                                                                                                                                                                                                                                            | `dkim_record`                                                                                                                | no        | —                                                                                     | —                                                                                                                           |
| `has_dmarc`            | `domain`, `subdomain`                                                                                                                                                                                                                                            | `dmarc_record`                                                                                                               | no        | —                                                                                     | —                                                                                                                           |
| `has_finding`          | `port`, `domain`, `subdomain`, `ip_address`, `ip_cidr`, `service`, `endpoint`, `certificate`, `parameter`, `dkim_record`, `storage_bucket`, `repository`, `identity_tenant`, `secret`, `mta_sts_policy`, `whois_registration`, `cloud_account`, `cloud_resource` | `finding`                                                                                                                    | no        | —                                                                                     | —                                                                                                                           |
...
| `has_registration`     | `domain`                                                                                                                                                                                                                                                         | `whois_registration`                                                                                                         | no        | —                                                                                     | —                                                                                                                           |
...
| `hosted_on`            | `domain`, `subdomain`, `endpoint`                                                                                                                                                                                                                                | `cloud_resource`                                                                                                             | no        | —                                                                                     | —                                                                                                                           |
| `in_account`           | `cloud_resource`, `storage_bucket`                                                                                                                                                                                                                               | `cloud_account`                                                                                                              | no        | —                                                                                     | —                                                                                                                           |
| `issued_by`            | `certificate`                                                                                                                                                                                                                                                    | `certificate`                                                                                                                | yes       | —                                                                                     | —                                                                                                                           |
| `links_to`             | `endpoint`                                                                                                                                                                                                                                                       | `endpoint`                                                                                                                   | yes       | `element`                                                                             | `element`: `html_token_or_empty`                                                                                            |
...
| `registered_through`   | `whois_registration`                                                                                                                                                                                                                                             | `registrar`                                                                                                                  | no        | —                                                                                     | —                                                                                                                           |
...
| `cloud_account`      | `has_finding`                                                                                                                                                                                                                                                                                                                                                                                                                        | `authenticates`, `in_account`                                                                                                                                                                               |
| `cloud_resource`     | `exposes_secret`, `has_finding`, `in_account`                                                                                                                                                                                                                                                                                                                                                                                        | `authenticates`, `hosted_on`                                                                                                                                                                                |
| `cve`                | `has_weakness`                                                                                                                                                                                                                                                                                                                                                                                                                       | `affected_by`                                                                                                                                                                                               |
| `cwe`                | —                                                                                                                                                                                                                                                                                                                                                                                                                                    | `has_weakness`                                                                                                                                                                                              |
| `dkim_record`        | `has_finding`                                                                                                                                                                                                                                                                                                                                                                                                                        | `has_dkim_selector`                                                                                                                                                                                         |
| `dmarc_record`       | —                                                                                                                                                                                                                                                                                                                                                                                                                                    | `has_dmarc`                                                                                                                                                                                                 |
| `domain`             | `backed_by_bucket`, `caa_issue`, `caa_issuewild`, `cname_to`, `dname_to`, `federates_with`, `has_contact`, `has_dkim_selector`, `has_dmarc`, `has_finding`, `has_mail_exchange`, `has_mta_sts_policy`, `has_nameserver`, `has_registration`, `has_soa_primary`, `has_spf`, `has_srv_target`, `has_subdomain`, `has_svcb_binding`, `has_txt_record`, `hosted_on`, `owns_repository`, `protected_by`, `resolves_to`, `runs_technology` | `caa_issue`, `caa_issuewild`, `cname_to`, `covers_name`, `dname_to`, `has_mail_exchange`, `has_nameserver`, `has_soa_primary`, `has_srv_target`, `has_svcb_binding`, `reverse_resolves_to`                  |
| `email_address`      | —                                                                                                                                                                                                                                                                                                                                                                                                                                    | `authenticates`, `has_contact`                                                                                                                                                                              |
| `endpoint`           | `affected_by`, `backed_by_bucket`, `exposes_secret`, `has_finding`, `has_http_fingerprint`, `has_parameter`, `hosted_on`, `links_to`, `protected_by`, `redirects_to`, `runs_technology`                                                                                                                                                                                                                                              | `authenticates`, `has_contact`, `links_to`, `redirects_to`, `serves_endpoint`                                                                                                                               |
| `finding`            | `affected_by`, `has_weakness`                                                                                                                                                                                                                                                                                                                                                                                                        | `has_finding`                                                                                                                                                                                               |
| `host_key`           | —                                                                                                                                                                                                                                                                                                                                                                                                                                    | `presents_host_key`                                                                                                                                                                                         |
| `http_fingerprint`   | —                                                                                                                                                                                                                                                                                                                                                                                                                                    | `has_http_fingerprint`                                                                                                                                                                                      |
| `identity_tenant`    | `has_finding`                                                                                                                                                                                                                                                                                                                                                                                                                        | `authenticates`, `federates_with`                                                                                                                                                                           |
...
| `repository`         | `exposes_secret`, `has_contact`, `has_finding`                                                                                                                                                                                                                                                                                                                                                                                       | `authenticates`, `owns_repository`                                                                                                                                                                          |
| `secret`             | `authenticates`, `has_finding`                                                                                                                                                                                                                                                                                                                                                                                                       | `exposes_secret`                                                                                                                                                                                            |
| `service`            | `affected_by`, `has_finding`, `has_tls_fingerprint`, `presents_certificate`, `presents_host_key`, `protected_by`, `runs_technology`, `serves_endpoint`, `supports_tls_cipher`                                                                                                                                                                                                                                                        | `authenticates`, `has_service`                                                                                                                                                                              |
| `spf_record`         | —                                                                                                                                                                                                                                                                                                                                                                                                                                    | `has_spf`                                                                                                                                                                                                   |
| `storage_bucket`     | `exposes_secret`, `has_finding`, `in_account`                                                                                                                                                                                                                                                                                                                                                                                        | `authenticates`, `backed_by_bucket`                                                                                                                                                                         |
| `subdomain`          | `backed_by_bucket`, `caa_issue`, `caa_issuewild`, `cname_to`, `dname_to`, `federates_with`, `has_contact`, `has_dkim_selector`, `has_dmarc`, `has_finding`, `has_mail_exchange`, `has_mta_sts_policy`, `has_nameserver`, `has_soa_primary`, `has_spf`, `has_srv_target`, `has_subdomain`, `has_svcb_binding`, `has_txt_record`, `hosted_on`, `owns_repository`, `protected_by`, `resolves_to`, `runs_technology`                     | `caa_issue`, `caa_issuewild`, `cname_to`, `covers_name`, `dname_to`, `has_mail_exchange`, `has_nameserver`, `has_soa_primary`, `has_srv_target`, `has_subdomain`, `has_svcb_binding`, `reverse_resolves_to` |
...
| `whois_registration` | `has_contact`, `has_finding`, `registered_through`                                                                                                                                                                                                                                                                                                                                                                                   | `has_registration`                                                                                                                                                                                          |
...
| Check                              | Types                                       | Rule                                                                                                                                                                                                                                                                                           |
| ---------------------------------- | ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `asn_assigned.1`                   | `asn`                                       | `value` 0 is rejected: AS0 is reserved and never originates routes (RFC 7607).                                                                                                                                                                                                                 |
...
| `cloud_account_spelling.1`         | `cloud_account`                             | `account_id` must be the declared provider's spelling: 12 digits for `aws`, a project id of 6 to 30 characters starting with a letter for `gcp`, a lowercase UUID subscription id for `azure`.                                                                                                 |
| `cloud_resource_hostname.1`        | `cloud_resource`                            | `hostname` must match exactly one provider-assigned default hostname pattern, and that pattern's service must be `service`. An alias form is refused with a pointer to the canonical one; `region`, when sent, must equal the region the hostname encodes and is refused on a regionless form. |
...
| `has_contact_endpoint_role.1`      | `has_contact`                               | An `endpoint` target requires `role` `iodef` and `method` `POST` (RFC 6546), and `iodef` never targets a `phone`: a CAA iodef names a mailto address or an https report URL.                                                                                                                   |
| `has_contact_registration_roles.1` | `has_contact`                               | From a `whois_registration`, `role` must be `registrant`, `admin`, `tech` or `billing`; from a `domain` or `subdomain`, those four roles are refused, because they belong to one registration.                                                                                                 |
| `has_registration_suffix_match.1`  | `has_registration`                          | The registration's `registry` must be the zone of its domain: the domain's `value` without its first label.                                                                                                                                                                                    |
...
| `in_account_provider_match.1`      | `in_account`                                | The account's `provider` must be the source's provider: the prefix of a cloud resource's `service`, or the provider behind a bucket's `provider`.                                                                                                                                              |
...
| `port_number_assigned.1`           | `port`                                      | `number` 0 is rejected: it is what a tool emits for a missing port, and no service listens there. The `uint16` format keeps 0 because SRV and MX values may legitimately be 0.                                                                                                                 |
| `registrar_iana_assigned.1`        | `registrar`                                 | `iana_id` must be at least 1, because 0 is what an agent emits for a missing field.                                                                                                                                                                                                            |
| `registry_domain_id_assigned.1`    | `whois_registration`                        | `registry_domain_id` is rejected when its part before the last hyphen is all zeros or a redaction word such as `REDACTED`, `NONE`, `NA`, `UNKNOWN`, `PRIVATE`, `WITHHELD` or `NOTDISCLOSED`, in any case.                                                                                      |
...
| `secret_plaintext_keys.1`          | `secret`, `authenticates`, `exposes_secret` | The record is rejected if any key at any depth, in any case, is `value`, `secret`, `plaintext`, `password`, `token`, `key`, `credential`, `match`, `raw`, `rawv2`, `redacted` or `line`, so the credential itself cannot reach storage.                                                        |
...
| `endpoint_url_drop_query.1` | `endpoint`                   | Once the whole `url`, query included, passes `http_url`, everything from its first `?` is removed before hashing and storage, so one path is one endpoint. A URL whose query is malformed is left unchanged and rejected. |
...
| `breach_token_or_empty`    | 1       | The empty string, or `<corpus>:<id>`: a lowercase tech_token naming the breach corpus, a colon, and 1 to 200 lowercase characters from letters, digits and `._/-`, such as `hibp:linkedin` or `leakcheck:linkedin.com`. Slug a display name: lowercase, runs of other characters become one `-`.                                                                                                                                                                                      |
...
| `cloud_account_id`         | 1       | 1 to 64 lowercase ASCII letters, digits and hyphens, starting and ending alphanumeric. The declared provider fixes the spelling: 12 digits for AWS, a project id for GCP, a lowercase UUID for Azure.                                                                                                                                                                                                                                                                                 |
| `cloud_region`             | 1       | 1 to 32 lowercase ASCII letters, digits and hyphens, starting and ending alphanumeric.                                                                                                                                                                                                                                                                                                                                                                                                |
...
| `html_token`               | 1       | An HTML element or attribute name: a lowercase letter, then up to 31 letters, digits or hyphens.                                                                                                                                                                                                                                                                                                                                                                                      |
| `html_token_or_empty`      | 1       | The empty string, or an html_token.                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `ip`                       | 1       | Canonical IPv4Address.compressed or lowercase IPv6Address.compressed spelling, without scope or prefix. An IPv4-mapped IPv6 address (`::ffff:192.0.2.1`) is rejected: write the IPv4 address.                                                                                                                                                                                                                                                                                         |
...
| `partial_date`             | 1       | `YYYY`, `YYYY-MM` or `YYYY-MM-DD`, a date known only to the precision the source gives.                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `username_or_empty`        | 1       | The empty string, or 1 to 256 printable ASCII characters without space: a login name exactly as the source spells it.                                                                                                                                                                                                                                                                                                                                                                 |
| `utc_timestamp`            | 1       | An instant in UTC as `YYYY-MM-DDTHH:MM:SSZ` with an optional 1-6 digit fraction before the `Z`. Offsets are rejected, so one instant has one spelling and stored values sort and compare as text.                                                                                                                                                                                                                                                                                     |
...
A provider tenancy container: an AWS account, a GCP project or an Azure subscription.
...
| Property     | Required | Rule                         | Meaning                                                                     |
| ------------ | -------- | ---------------------------- | --------------------------------------------------------------------------- |
| `account_id` | yes      | `cloud_account_id`           | The provider's id: AWS account id, GCP project id or Azure subscription id. |
| `provider`   | yes      | one of `aws`, `gcp`, `azure` | The cloud provider.                                                         |

### `cloud_resource`

A provider-managed resource that answers at a provider-assigned default hostname, such as a CloudFront distribution, an App Service app or a Firebase site, keyed on that hostname.

**Not modeled:** Not the DNS name as such (`subdomain`), not object storage (`storage_bucket`) and not a path-addressed resource such as a Cloud Function, which is an `endpoint`.
...
| Property   | Required | Rule                                                                                                                                                                                                                                                                                                | Meaning                                                                |
| ---------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `hostname` | yes      | `dns_name`                                                                                                                                                                                                                                                                                          | The canonical provider-assigned default hostname.                      |
| `service`  | yes      | one of `aws_cloudfront`, `aws_api_gateway`, `aws_lambda_url`, `aws_elastic_beanstalk`, `aws_elb`, `azure_app_service`, `azure_cloud_service`, `azure_public_ip`, `azure_traffic_manager`, `azure_front_door`, `azure_api_management`, `gcp_app_engine`, `gcp_firebase_hosting`, `gcp_firebase_rtdb` | The provider service, fixed by which default hostname pattern matches. |
| `region`   | no       | `cloud_region`                                                                                                                                                                                                                                                                                      | The region the hostname encodes, when it encodes one.                  |
...
| `url`            | yes      | `http_url`            | Absolute canonical http/https URL; a valid submitted query string is removed before identity. |
...
| `detector`     | no       | `tech_token`                                                                                                                               | The scanner rule that found it, such as trufflehog's `aws`; not identity.              |
| `key_id`       | no       | `credential_key_id`                                                                                                                        | The public identifier half of a two-part credential, such as an AWS access key id.     |
| `kind`         | no       | one of `password`, `password_hash`, `api_key`, `access_token`, `private_key`, `session_token`, `connection_string`, `webhook_url`, `other` | What the secret is; send it whenever the source says, and `other` only when it cannot. |
| `verified`     | no       | `boolean`                                                                                                                                  | Whether the scanner confirmed the credential works; the latest write wins.             |
...
One registry-level registration of a registrable domain, known by the repository object id the registry assigns (RDAP `handle`, WHOIS `Registry Domain ID`) and scoped through `has_registration`.

**Not modeled:** Not the domain name, which outlives registrations; not the registrant, since person and company types are out of scope; and not a WHOIS or RDAP response, which is evidence.
...
| Property               | Required | Rule                 | Meaning                                                                                           |
| ---------------------- | -------- | -------------------- | ------------------------------------------------------------------------------------------------- |
| `registry`             | yes      | `public_suffix`      | The zone the name is registered in, such as `com` or `co.uk`: the domain without its first label. |
| `registry_domain_id`   | yes      | `registry_domain_id` | The registry's repository object id for this registration, exactly as published.                  |
| `dnssec_signed`        | no       | `boolean`            | Whether the registry holds DS records for the name (RDAP `delegationSigned`).                     |
| `epp_status`           | no       | `epp_status_list`    | The EPP status codes the registry reports, sorted.                                                |
| `registration_created` | no       | `utc_timestamp`      | When the registration was created (RDAP `registration` event).                                    |
| `registration_expires` | no       | `utc_timestamp`      | When it expires unless renewed (RDAP `expiration` event).                                         |
| `registration_updated` | no       | `utc_timestamp`      | When the registry last changed it (RDAP `last changed` event).                                    |
| `whois_server`         | no       | `dns_name`           | The registry's port-43 WHOIS server, never the registrar's.                                       |
...
The secret is a credential for the principal: a mailbox, account, tenant, repository, service, endpoint, bucket or cloud resource, optionally for one login name and one breach.
...
| Property       | Required | Rule                    | Meaning                                                                              |
| -------------- | -------- | ----------------------- | ------------------------------------------------------------------------------------ |
| `breach`       | yes      | `breach_token_or_empty` | The corpus and breach id the pair was published in, or empty for a live scanner hit. |
| `username`     | yes      | `username_or_empty`     | The login name the credential is for, as the source spells it, or empty.             |
| `breach_date`  | no       | `partial_date`          | When the breach happened, to the precision the corpus gives.                         |
| `breach_title` | no       | `printable_text_200`    | The corpus's display name for the breach; the latest write wins.                     |
| `verified`     | no       | `boolean`               | Whether the pair was confirmed to work.                                              |
...
**Not modeled:** Never the secret itself; the node holds only its digest, and plaintext-bearing keys are refused.

Link evidence only after replacing every secret-bearing scanner field with `[REDACTED]`.

**Identity:** `location`<br>**Sources:** `repository`, `endpoint`, `storage_bucket`, `cloud_resource`<br>**Targets:** `secret`<br>**Self edge:** no<br>**Checks:** `secret_plaintext_keys.1`<br>**Canonicalizations:** —
...
The source publishes the contact for one role, including a CAA iodef report address or URL.

**Not modeled:** Not a person record; person and company types are out of scope.

Use `published` for an address harvested from an organization's own surface with no declared role. Registrant, admin, tech and billing contacts come from registration data and attach to the `whois_registration`, so a re-registration does not inherit them.

**Identity:** `role`<br>**Sources:** `organization`, `registrar`, `domain`, `subdomain`, `repository`, `whois_registration`<br>**Targets:** `email_address`, `phone`, `endpoint`<br>**Self edge:** no<br>**Checks:** `has_contact_registration_roles.1`, `has_contact_endpoint_role.1`<br>**Canonicalizations:** —

| Property | Required | Rule                                                                                              | Meaning                                                                           |
| -------- | -------- | ------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| `role`   | yes      | one of `abuse`, `admin`, `tech`, `registrant`, `billing`, `noc`, `security`, `published`, `iodef` | What the contact is for; identity-bearing, so one address may hold several roles. |
...
**Identity:** —<br>**Sources:** `port`, `domain`, `subdomain`, `ip_address`, `ip_cidr`, `service`, `endpoint`, `certificate`, `parameter`, `dkim_record`, `storage_bucket`, `repository`, `identity_tenant`, `secret`, `mta_sts_policy`, `whois_registration`, `cloud_account`, `cloud_resource`<br>**Targets:** `finding`<br>**Self edge:** no<br>**Checks:** —<br>**Canonicalizations:** —
...
The domain has this registration; the scope relation of `whois_registration`.

**Not modeled:** Not a registrar relationship, which is `registered_through` from the registration.

**Identity:** —<br>**Sources:** `domain`<br>**Targets:** `whois_registration`<br>**Self edge:** no<br>**Checks:** `has_registration_suffix_match.1`<br>**Canonicalizations:** —
...
A name or URL serves from the cloud resource, typically through a CNAME to its default hostname.

**Not modeled:** Not ownership of the resource; `in_account` records whose account it is.

**Identity:** —<br>**Sources:** `domain`, `subdomain`, `endpoint`<br>**Targets:** `cloud_resource`<br>**Self edge:** no<br>**Checks:** —<br>**Canonicalizations:** —

### `in_account`

The cloud resource or bucket belongs to the account.

**Not modeled:** Not the account's identity provider, which is an `identity_tenant`.

**Identity:** —<br>**Sources:** `cloud_resource`, `storage_bucket`<br>**Targets:** `cloud_account`<br>**Self edge:** no<br>**Checks:** `in_account_provider_match.1`<br>**Canonicalizations:** —
...
The source page references the target URL, through one HTML element.

**Not modeled:** Not an HTTP redirect (`redirects_to`) and not a URL guessed by brute force.

Identity is `element`, so a script include and an anchor to one URL are two edges; `attribute` is last-writer-wins. Use `""` when the crawler reports no element.

**Identity:** `element`<br>**Sources:** `endpoint`<br>**Targets:** `endpoint`<br>**Self edge:** yes<br>**Checks:** —<br>**Canonicalizations:** —

| Property    | Required | Rule                  | Meaning                                                          |
| ----------- | -------- | --------------------- | ---------------------------------------------------------------- |
| `element`   | yes      | `html_token_or_empty` | The referencing HTML element, such as `a` or `script`, or empty. |
| `attribute` | no       | `html_token`          | The attribute that held the URL, such as `href` or `src`.        |
...
The registration is sponsored by the registrar.

**Not modeled:** Not a fact about the name across time: after a transfer or a re-registration, each registration keeps its own registrar edge.

**Identity:** —<br>**Sources:** `whois_registration`<br>**Targets:** `registrar`<br>**Self edge:** no<br>**Checks:** —<br>**Canonicalizations:** —
