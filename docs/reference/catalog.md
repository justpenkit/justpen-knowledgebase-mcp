...
The catalog declares **34 node types** and **47 relation types**. Conventions that the catalog does not enforce, and the longer reasoning behind each type, live in [Graph and search](../tools/graph.md).
...
| `has_contact`          | `organization`, `registrar`, `domain`, `subdomain`, `repository`, `whois_registration`                                                                                                                                                                           | `email_address`, `phone` | no        | `role`                                                                                | `role`: one of `abuse`, `admin`, `tech`, `registrant`, `billing`, `noc`, `security`, `published`                            |
...
| `cloud_account`      | `has_finding`                                                                                                                                                                                                                                                                                                                                                                                                                        | `in_account`                                                                                                                                                                                                |
| `cloud_resource`     | `exposes_secret`, `has_finding`, `in_account`                                                                                                                                                                                                                                                                                                                                                                                        | `hosted_on`                                                                                                                                                                                                 |
...
| `endpoint`           | `affected_by`, `backed_by_bucket`, `exposes_secret`, `has_finding`, `has_http_fingerprint`, `has_parameter`, `hosted_on`, `protected_by`, `redirects_to`, `runs_technology`                                                                                                                                                                                                                                                          | `redirects_to`, `serves_endpoint`                                                                                                                                                                           |
...
| `spf_record`         | —                                                                                                                                                                                                                                                                                                                                                                                                                                    | `has_spf`                                                                                                                                                                                                   |
| `storage_bucket`     | `exposes_secret`, `has_finding`, `in_account`                                                                                                                                                                                                                                                                                                                                                                                        | `backed_by_bucket`                                                                                                                                                                                          |
...
| `secret_plaintext_keys.1`          | `secret`, `exposes_secret` | The record is rejected if any key at any depth, in any case, is `value`, `secret`, `plaintext`, `password`, `token`, `key`, `credential`, `match`, `raw`, `rawv2`, `redacted` or `line`, so the credential itself cannot reach storage.                                                        |
...
**Identity:** `role`<br>**Sources:** `organization`, `registrar`, `domain`, `subdomain`, `repository`, `whois_registration`<br>**Targets:** `email_address`, `phone`<br>**Self edge:** no<br>**Checks:** `has_contact_registration_roles.1`<br>**Canonicalizations:** —
